...
AmCharts.ValueAxis = AmCharts.Class({inherits: AmCharts.AxisBase, construct: function (a) {
    ...
    for (k = this.start; k <= this.end; k++) {
        ...
        for (p = 0; p < h.length; p++)if (m = h[p], !m.hidden && (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, !isNaN(g)))) {
            ...
            r = m.fillToGraph;
            q && r && (r = this.data[k].axes[this.id].graphs[r.id]) && (l.values.open = r.values.value);
            "regular" ==
                b && (q && (isNaN(c[k]) ? (c[k] = g, l.values.close = g, l.values.open = this.baseValue) : (isNaN(g) ? l.values.close = c[k] : l.values.close = g + c[k], l.values.open = c[k], c[k] = l.values.close)), "column" != a || isNaN(g) || (m.newStack && (f[k] = NaN, d[k] = NaN), l.values.close = g, 0 > g ? (l.values.close = g, isNaN(d[k]) ? l.values.open = n : (l.values.close += d[k], l.values.open = d[k]), d[k] = l.values.close) : (l.values.close = g, isNaN(f[k]) ? l.values.open = n : (l.values.close += f[k], l.values.open = f[k]), f[k] = l.values.close)))
        }
    }
    ...
    for (b = 0; b < a.length; b++) {
        ...
        if (c.valueAxis == this) {
            ...
            for (d = h; d <= g; d++) {
                ...
                e.percents = {};
                var h = e.values, l;
                for (l in h)e.percents[l] = "percents" != l ?
                    h[l] / f * 100 - 100 : h[l]
            }
        }
    }
    ...
    for (b = this.start; b <= this.end; b++) {
        ...
        for (d in c)if (c.hasOwnProperty(d)) {
            ...
            if (f.includeInMinMax && (!f.hidden || this.includeHidden)) {
                ...
                var e;
                if (this.minMaxField)e = f[this.minMaxField], e > a && (a = e); else for (var g in f)f.hasOwnProperty(g) && "percents" != g && "total" != g && (e = f[g], e > a && (a = e))
            }
        }
    }
    return a
